...
def _get_dataset(dataset_name):
    ...
    if dataset_name == "optimization":
        dataset_path = os.path.join(config.dataset_root, "hipspec/optimization")
    ...
    expensive_list = config.hipspec_expensive_props.get(dataset_name, [])
