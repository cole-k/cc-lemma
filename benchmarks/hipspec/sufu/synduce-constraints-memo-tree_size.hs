...
tf8 :: Tree -> Nat
tf8 (Leaf tv32) = (Succ Zero)
tf8 (Node tv33 tv34 tv35) = (plus (Succ Zero) (plus (tf7 tv34) (tf7 tv35)))
...
main :: TreeMemo -> Nat
main tv36 = (ite2 (ismemo tv36) (spec (repr (target tv36))))

mainNew :: TreeMemo -> Nat
mainNew tv37 = (ite2 (ismemo tv37) (memo tv37))
