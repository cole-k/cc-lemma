...
main :: Zipper -> Nat
main tv19 = (height (repr tv19))

tf5 :: Zipper -> Nat
tf5 (Top tv23) = Zero
tf5 (Left tv24 tv25 tv26) = (plus (Succ Zero) (max (height tv25) (tf4 tv26)))
tf5 (Right tv27 tv28 tv29) = (plus (Succ Zero) (max (height tv28) (tf4 tv29)))
