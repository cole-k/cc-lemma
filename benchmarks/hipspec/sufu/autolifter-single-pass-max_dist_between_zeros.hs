...
tf2 :: List -> Nat
tf2 tv9 = (maxdistbetweenzeros (tf0 tv9))
...
tf4 tv16 (Cons tv18 tv19) = (max (ite1 (not tv18) Zero (plus tv16 (Succ Zero))) (tf3 (ite1 (not tv18) Zero (plus tv16 (Succ Zero))) tv19))

tf3 :: Nat -> List -> Nat
tf3 tv13 tv14 = (tf4 tv13 tv14)

maxdistbetweenzeros :: List -> Nat
maxdistbetweenzeros tv12 = (tf3 Zero tv12)
