...
tf4 tv15 tv16 (Nil tv17) = tv16
tf4 tv15 tv16 (Cons tv18 tv19) = (tf3 tv18 (ite1 (and (not tv15) tv18) (plus tv16 (Succ Zero)) tv16) tv19)

tf3 :: Bool -> Nat -> List -> Nat
tf3 tv11 tv12 tv13 = (tf4 tv11 tv12 tv13)

cnt1s :: List -> Nat
cnt1s tv10 = (tf3 False Zero tv10)

main :: List -> Nat
main tv20 = (singlepass tv20)

data Tuple2 = MakeTuple2 Nat Bool deriving (Eq, Typeable, Ord)
...
tf6 :: List -> Tuple2
tf6 (Nil tv25) = (MakeTuple2 Zero False)
tf6 (Cons tv26 tv27) = (MakeTuple2 (ite1 (or (not tv26) (snd2 (tf5 tv27))) (fst2 (tf5 tv27)) (plus (Succ Zero) (fst2 (tf5 tv27)))) tv26)
