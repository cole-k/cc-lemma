...
tf1 :: List -> Tuple3
tf1 (Nil tv5) = (MakeTuple3 Zero Zero Zero)
tf1 (Cons tv6 tv7) = (MakeTuple3 (plus tv6 (fst3 (tf0 tv7))) (max Zero (plus tv6 (snd3 (tf0 tv7)))) (max (third3 (tf0 tv7)) (plus tv6 (fst3 (tf0 tv7)))))
...
spec :: List -> Tuple4
spec tv2 = (MakeTuple4 (snd3 (tf0 tv2)) (third3 (tf0 tv2)))
...
tf7 :: CList -> Tuple3
tf7 (Cnil tv28) = (MakeTuple3 Zero Zero Zero)
tf7 (Single tv29) = (MakeTuple3 (max tv29 Zero) (ite2 (lq tv29 Zero) Zero tv29) tv29)
tf7 (Concat tv30 tv31) = (MakeTuple3 (max (fst3 (tf6 tv30)) (plus (fst3 (tf6 tv31)) (third3 (tf6 tv30)))) (ite2 (lq (plus (third3 (tf6 tv31)) (snd3 (tf6 tv30))) (snd3 (tf6 tv31))) (snd3 (tf6 tv31)) (plus (third3 (tf6 tv31)) (snd3 (tf6 tv30)))) (plus (third3 (tf6 tv31)) (third3 (tf6 tv30))))
...
mainNew tv32 = (MakeTuple4 (fst3 (reprNew tv32)) (snd3 (reprNew tv32)))
