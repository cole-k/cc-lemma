...
tf7 (Cons tv31 tv32) = (MakeTuple3 (max tv31 (fst3 (tf6 tv32))) (max (snd3 (tf6 tv32)) (min (fst3 (tf6 tv32)) tv31)))
...
tf11 :: CList -> Tuple3
tf11 (Cnil tv44) = (MakeTuple3 Zero Zero)
tf11 (Single tv45) = (MakeTuple3 Zero tv45)
tf11 (Concat tv46 tv47) = (MakeTuple3 (ite2 (and (lq (snd3 (tf10 tv47)) (snd3 (tf10 tv46))) (lq (fst3 (tf10 tv46)) (snd3 (tf10 tv47)))) (snd3 (tf10 tv47)) (ite2 (lq (snd3 (tf10 tv46)) (fst3 (tf10 tv47))) (fst3 (tf10 tv47)) (ite2 (lq (snd3 (tf10 tv47)) (snd3 (tf10 tv46))) (fst3 (tf10 tv46)) (snd3 (tf10 tv46))))) (max (snd3 (tf10 tv46)) (snd3 (tf10 tv47))))

tf10 :: CList -> Tuple3
tf10 tv42 = (tf11 tv42)

targetNew :: CList -> Tuple3
targetNew tv41 = (tf10 tv41)

mainNew :: CList -> Nat
mainNew tv48 = (ite2 (allpos tv48) (fst3 (targetNew tv48)) Zero)
