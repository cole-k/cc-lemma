  ...
  (assert (forall ((tv18 IndexedList) (tv17 Nat) (tv16 Nat)) (= (tf5 (Icons tv16 tv17 tv18)) (plus (times tv16 tv17) (tf4 tv18)))))
  ...
  (assert (forall ((tv25 List) (tv24 Nat)) (= (tf7 (Cons tv24 tv25)) (plus (tf6 tv25) (times (length tv25) tv24)))))
