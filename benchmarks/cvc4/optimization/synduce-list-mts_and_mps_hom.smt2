  ...
  (assert (forall ((tv5 Unit)) (= (tf1 (Nil tv5)) (MakeTuple3 Zero Zero Zero))))
  (assert (forall ((tv7 List) (tv6 Nat)) (= (tf1 (Cons tv6 tv7)) (MakeTuple3 (plus tv6 (fst3 (tf0 tv7))) (max Zero (plus tv6 (snd3 (tf0 tv7)))) (max (third3 (tf0 tv7)) (plus tv6 (fst3 (tf0 tv7))))))))
  (assert (forall ((tv3 List)) (= (tf0 tv3) (tf1 tv3))))
  (assert (forall ((tv2 List)) (= (spec tv2) (MakeTuple4 (snd3 (tf0 tv2)) (third3 (tf0 tv2))))))
  ...
  (assert (forall ((tv28 Unit)) (= (tf7 (Cnil tv28)) (MakeTuple3 Zero Zero Zero))))
  (assert (forall ((tv29 Nat)) (= (tf7 (Single tv29)) (MakeTuple3 (max tv29 Zero) (ite2 (lq tv29 Zero) Zero tv29) tv29))))
  (assert (forall ((tv31 CList) (tv30 CList)) (= (tf7 (Concat tv30 tv31)) (MakeTuple3 (max (fst3 (tf6 tv30)) (plus (fst3 (tf6 tv31)) (third3 (tf6 tv30)))) (ite2 (lq (plus (third3 (tf6 tv31)) (snd3 (tf6 tv30))) (snd3 (tf6 tv31))) (snd3 (tf6 tv31)) (plus (third3 (tf6 tv31)) (snd3 (tf6 tv30)))) (plus (third3 (tf6 tv31)) (third3 (tf6 tv30)))))))
  (assert (forall ((tv26 CList)) (= (tf6 tv26) (tf7 tv26))))
  (assert (forall ((tv25 CList)) (= (reprNew tv25) (tf6 tv25))))
  (assert (forall ((tv32 CList)) (= (mainNew tv32) (MakeTuple4 (fst3 (reprNew tv32)) (snd3 (reprNew tv32))))))
