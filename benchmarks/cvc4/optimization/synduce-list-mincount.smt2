  ...
  (assert (forall ((tv7 List) (tv6 Nat)) (= (tf1 (Cons tv6 tv7)) (MakeTuple3 (min (fst3 (tf0 tv7)) tv6) (ite2 (lq tv6 (fst3 (tf0 tv7))) (Succ Zero) (plus (snd3 (tf0 tv7)) (ite2 (nateq tv6 (fst3 (tf0 tv7))) (Succ Zero) Zero)))))))
  ...
  (assert (forall ((tv29 CList) (tv28 CList)) (= (tf7 (Concat tv28 tv29)) (MakeTuple3 (ite2 (lq (snd3 (tf6 tv28)) (snd3 (tf6 tv29))) (fst3 (tf6 tv28)) (ite2 (nateq (snd3 (tf6 tv29)) (snd3 (tf6 tv28))) (plus (fst3 (tf6 tv29)) (fst3 (tf6 tv28))) (fst3 (tf6 tv29)))) (min (snd3 (tf6 tv29)) (snd3 (tf6 tv28)))))))
