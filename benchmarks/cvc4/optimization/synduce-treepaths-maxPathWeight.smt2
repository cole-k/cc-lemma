  ...
  (assert (forall ((tv19 Zipper)) (= (main tv19) (mpath (repr tv19)))))
  (assert (forall ((tv23 Unit)) (= (tf5 (Top tv23)) Zero)))
  (assert (forall ((tv25 BTree) (tv26 Zipper) (tv24 Nat)) (= (tf5 (Left tv24 tv25 tv26)) (plus tv24 (max (tf4 tv26) (mpath tv25))))))
  (assert (forall ((tv29 Zipper) (tv28 BTree) (tv27 Nat)) (= (tf5 (Right tv27 tv28 tv29)) (plus tv27 (max (tf4 tv29) (mpath tv28))))))
