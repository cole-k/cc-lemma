  ...
  (assert (forall ((tv9 List)) (= (tf2 tv9) (sum (tf0 tv9)))))
  ...
  (assert (forall ((tv15 List) (tv14 Nat)) (= (tf4 (Cons tv14 tv15)) (plus tv14 (tf3 tv15)))))
  (assert (forall ((tv11 List)) (= (tf3 tv11) (tf4 tv11))))
  (assert (forall ((tv10 List)) (= (sum tv10) (tf3 tv10))))
  (assert (forall ((tv16 List)) (= (main tv16) (singlepass tv16))))
  (assert (forall ((tv21 Unit)) (= (tf6 (Nil tv21)) Zero)))
  (assert (forall ((tv23 List) (tv22 Nat)) (= (tf6 (Cons tv22 tv23)) (plus tv22 (tf5 tv23)))))
