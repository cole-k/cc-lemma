  ...
  (assert (forall ((tv9 Tree) (tv8 Nat) (tv10 Tree) (tv6 Nat)) (= (tf1 tv6 (Node tv8 tv9 tv10)) (tf0 (max (tf0 tv6 tv9) tv8) tv10))))
  ...
  (assert (forall ((tv25 Tree) (tv24 Tree) (tv23 Nat)) (= (tf5 (Node tv23 tv24 tv25)) (max tv23 (max (tf4 tv25) (tf4 tv24))))))
