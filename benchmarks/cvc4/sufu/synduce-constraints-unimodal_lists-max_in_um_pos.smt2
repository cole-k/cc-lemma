  ...
  (assert (forall ((tv16 Unit) (tv15 Nat)) (= (tf3 tv15 (Nil tv16)) (geq tv15 Zero))))
  (assert (forall ((tv18 List) (tv17 Nat) (tv15 Nat)) (= (tf3 tv15 (Cons tv17 tv18)) (myand (geq tv15 Zero) (myand (gq tv15 tv17) (tf2 tv17 tv18))))))
  ...
  (assert (forall ((tv23 Unit) (tv22 Nat)) (= (tf5 tv22 (Nil tv23)) (geq tv22 Zero))))
  (assert (forall ((tv25 List) (tv24 Nat) (tv22 Nat)) (= (tf5 tv22 (Cons tv24 tv25)) (myand (geq tv22 Zero) (ite2 (lq tv22 tv24) (tf4 tv24 tv25) (tf2 tv24 tv25))))))
  ...
  (assert (forall ((tv45 Nat) (tv46 UList) (tv44 Nat) (tv43 UList)) (= (tf11 (Usplit tv43 tv44 tv45 tv46)) (Usplit (tf10 tv43) tv44 tv45 (tf10 tv46)))))
  ...
  (assert (forall ((tv56 UList) (tv54 Nat) (tv55 Nat) (tv53 UList)) (= (tf13 (Usplit tv53 tv54 tv55 tv56)) (ite3 (myand (lq (tf12 tv56) (max tv55 tv54)) (lq (tf12 tv53) (max tv55 tv54))) (max tv55 tv54) (ite3 (lq (tf12 tv56) (tf12 tv53)) (tf12 tv53) (tf12 tv56))))))
