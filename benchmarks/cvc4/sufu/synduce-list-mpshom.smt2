  ...
  (assert (forall ((tv7 List) (tv6 Nat)) (= (tf1 (Cons tv6 tv7)) (MakeTuple3 (max Zero (plus tv6 (fst3 (tf0 tv7)))) (plus tv6 (snd3 (tf0 tv7)))))))
  ...
  (assert (forall ((tv29 Nat)) (= (tf7 (Single tv29)) (MakeTuple3 (max tv29 Zero) tv29))))
  (assert (forall ((tv31 CList) (tv30 CList)) (= (tf7 (Concat tv30 tv31)) (MakeTuple3 (max (fst3 (tf6 tv30)) (plus (fst3 (tf6 tv31)) (snd3 (tf6 tv30)))) (plus (snd3 (tf6 tv31)) (snd3 (tf6 tv30)))))))
