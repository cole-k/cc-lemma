  ...
  (declare-fun longest1s (List) Nat)
  ...
  (assert (forall ((tv9 List)) (= (tf2 tv9) (longest1s (tf0 tv9)))))
  ...
  (assert (forall ((tv19 List) (tv18 MyBool) (tv16 Nat)) (= (tf4 tv16 (Cons tv18 tv19)) (max (ite1 tv18 (plus tv16 (Succ Zero)) Zero) (tf3 (ite1 tv18 (plus tv16 (Succ Zero)) Zero) tv19)))))
  (assert (forall ((tv14 List) (tv13 Nat)) (= (tf3 tv13 tv14) (tf4 tv13 tv14))))
  (assert (forall ((tv12 List)) (= (longest1s tv12) (tf3 Zero tv12))))
