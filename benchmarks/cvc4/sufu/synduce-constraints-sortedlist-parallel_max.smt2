  ...
  (assert (forall ((tv42 List) (tv41 Nat)) (= (tf11 (Cons tv41 tv42)) (max tv41 (tf10 tv42)))))
  ...
  (assert (forall ((tv49 CList) (tv48 CList) (tv46 CList)) (= (tf13 tv46 (Concat tv48 tv49)) (Concat tv48 (tf12 tv49)))))
  ...
  (assert (forall ((tv56 CList) (tv55 CList)) (= (tf15 (Concat tv55 tv56)) (tf14 tv56))))
