  ...
  (assert (forall ((tv5 Nat) (tv4 Nat)) (= (tf1 tv4 (Elt tv5)) (geq tv4 tv5))))
  (assert (forall ((tv7 List) (tv6 Nat) (tv4 Nat)) (= (tf1 tv4 (Cons tv6 tv7)) (myand (geq tv4 tv6) (tf0 tv6 tv7)))))
  ...
  (assert (forall ((tv13 Nat) (tv12 Nat)) (= (max tv12 tv13) (ite1 (lq tv12 tv13) tv13 tv12))))
  (assert (forall ((tv17 Nat)) (= (tf5 (Elt tv17)) tv17)))
  (assert (forall ((tv19 List) (tv18 Nat)) (= (tf5 (Cons tv18 tv19)) (max tv18 (tf4 tv19)))))
  (assert (forall ((tv15 List)) (= (tf4 tv15) (tf5 tv15))))
  (assert (forall ((tv14 List)) (= (maximum tv14) (tf4 tv14))))
  ...
  (assert (forall ((tv26 List)) (= (main tv26) (ite1 (issorted tv26) (maximum (target tv26)) Zero))))
